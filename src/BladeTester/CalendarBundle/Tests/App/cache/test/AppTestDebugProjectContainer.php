...
class AppTestDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/cache/test/annotations', true);
    }
    ...
    {
        return $this->services['blade_tester_calendar.calendar'] = new \BladeTester\CalendarBundle\Model\Calendar($this->get('doctrine.orm.default_entity_manager'), 'BladeTester\\CalendarBundle\\Tests\\App\\Entity\\Event');
    }
    ...
    {
        return $this->services['blade_tester_calendar.forms.event'] = new \BladeTester\CalendarBundle\Form\Type\EventFormType('BladeTester\\CalendarBundle\\Tests\\App\\Entity\\Event');
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'calendar_test', 'user' => 'root', 'password' => 'mysqldb', 'charset' => 'utf8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_2e5a50768f3edec0a5d1a7515691890b939d7eb48bbdbadc0c893ca872a5c84d');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_2e5a50768f3edec0a5d1a7515691890b939d7eb48bbdbadc0c893ca872a5c84d');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_2e5a50768f3edec0a5d1a7515691890b939d7eb48bbdbadc0c893ca872a5c84d');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Resources/config/doctrine' => 'BladeTester\\CalendarBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/Entity')), 'BladeTester\\CalendarBundle\\Tests\\App\\Entity');
        $e->addDriver($d, 'BladeTester\\CalendarBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('calendar_test' => 'BladeTester\\CalendarBundle\\Tests\\App\\Entity', 'BladeTesterCalendarBundle' => 'BladeTester\\CalendarBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/cache/test/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/Resources');
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/cache/test/profiler', '', '', 86400), NULL);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/cache/test/secure_random.seed', NULL);
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/cache/test/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/cache/test/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/cache/test/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/cache/test/twig', 'charset' => 'UTF-8', 'debug' => true, 'paths' => array()));

        $instance->addExtension(new \Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension());
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\TranslationExtension($this->get('translator')));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\AssetsExtension($this));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\ActionsExtension($this));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/calendar-bundle/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/var/www/calendar-bundle/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Resources/views', 'BladeTesterCalendar');
        $instance->addPath('/var/www/calendar-bundle/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/var/www/calendar-bundle/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/cache/test');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 1 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/var/www/calendar-bundle/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 2 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Resources/config/validation.yml')))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App',
            'kernel.environment' => 'test',
            'kernel.debug' => true,
            'kernel.name' => 'App',
            'kernel.cache_dir' => '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/cache/test',
            'kernel.logs_dir' => '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/logs',
            ...
            'debug.container.dump' => '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/cache/test/AppTestDebugProjectContainer.xml',
            ...
            'session.save_path' => '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/cache/test/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/var/www/calendar-bundle/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Resources/config/validation.yml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/cache/test/profiler',
            ...
            'router.resource' => '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/routing.yml',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/cache/test/doctrine/orm/Proxies',
            'doctrine.orm.proxy_namespace' => 'Proxies',
            'blade_tester_calendar.form.type.event.class' => 'BladeTester\\CalendarBundle\\Form\\Type\\EventFormType',
            'blade_tester_calendar.classes.event.entity' => 'BladeTester\\CalendarBundle\\Tests\\App\\Entity\\Event',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/calendar-bundle/src/BladeTester/CalendarBundle/Tests/App/cache/test/twig',
                'charset' => 'UTF-8',
                'debug' => true,
                'paths' => array(
